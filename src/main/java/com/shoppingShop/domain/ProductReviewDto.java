...
public class ProductReviewDto {
    ...
    public ProductReviewDto(int reviewId, Integer  proId, String  rating, String comment, int excellent, int good, int average, int poor, int terrible, Date createdAt) {
